...
import org.pvlpech.microservices.core.review.persistence.ReviewRepository;
...
@DataJpaTest
//By default, Spring Boot configures the tests to roll back updates to
//the SQL database to minimize the risk of negative side effects on
//other tests. In our case, this behavior will cause some of the tests to
//fail. Therefore, automatic rollback is disabled with the class level
//annotation:
@Transactional(propagation = NOT_SUPPORTED)
//The @DataMongoTest and @DataJpaTest annotations are designed to start an
